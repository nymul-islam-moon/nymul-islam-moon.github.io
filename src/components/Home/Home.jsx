        ...
        <div className="intro">
          ...
          <ul className="social-icons">
            <li><a href="https://stackoverflow.com/users/13756777/nymul-islam-moon" target="_blank" rel="noopener noreferrer" title="Stack Overflow">
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M21 24H3V0h18v24zM5.98 20.71h12.04v-1.71H5.98v1.71zm0-4.26h12.04v-1.71H5.98v1.71zm.49-5.41l10.73 1.62.23-1.71-10.73-1.62-.23 1.71zM6.52 7.62l9.96 4.71.98-1.93-9.96-4.71-.98 1.93zM9.64 3.24l8.07 6.56 1.45-1.79-8.07-6.56-1.45 1.79z"/></svg>
            </a></li>
